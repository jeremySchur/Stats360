...
public class ChampionInterpreterContext {
    private static ChampionInterpreterContext championNameInterpreter = new ChampionInterpreterContext();
    private Map<Integer, String> championMap = new HashMap<>();


    private ChampionInterpreterContext(){
    ...
    public static ChampionInterpreterContext getInstance(){
        return championNameInterpreter;
    }

    public String interpret(Integer id) {
